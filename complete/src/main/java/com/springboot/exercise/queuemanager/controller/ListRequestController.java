...
import com.springboot.exercise.model.json.JobInfo;
...
public class ListRequestController {
    ...
    @Transactional
    public @ResponseBody ResponseEntity<String> listQueue(@RequestParam("priority") Integer priority) throws JsonProcessingException {
        List<Job> jobs = null;
        if(priority == null) {
